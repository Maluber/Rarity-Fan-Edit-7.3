...
function R:PrepareDefaults()
   ...
   groups = {
    ...
    mounts = {
	 ...
	 ["Pond Nettle"] = 									 { cat = LEGION, type = MOUNT, method = FISHING, name = L["Pond Nettle"], spellId = 253711, itemId = 152912, zones = { 1171 }, chance = 5000, sourceText = L["'Hope's Landing' safest place to fish."], requiresPool = false, coords = { {m=1171} }, },
	 ["Acid Belcher"] =									 { cat = LEGION, type = MOUNT, method = NPC, name = L["Acid Belcher"], spellId = 253662, itemId = 152904, npcs = { 126912 }, questId = 48721, chance = 30, coords = { {m=1170,x=49.8,y=10} }, },
 	 ["Biletooth Gnasher"] = 							 { cat = LEGION, type = MOUNT, method = NPC, name = L["Biletooth Gnasher"], spellId = 253660, itemId = 152903, npcs = { 126199, 126040 }, chance = 30, questId = { 48810, 48809 }, coords = { {m=1171,x=53.2,y=35.8},{m=1171,x=65.5,y=26.7} }, },
	 ["Crimson Slavermaw"] = 							 { cat = LEGION, type = MOUNT, method = NPC, name = L["Crimson Slavermaw"], spellId = 253661, itemId = 152905, npcs = { 122958 }, chance = 30, questId = 49183, coords = { {m=1171,x=61.8,y=37.3} }, },
	 ["Lambent Mana Ray"] = 							 { cat = LEGION, type = MOUNT, method = NPC, name = L["Lambent Mana Ray"], spellId = 253107, itemId = 152844, npcs = { 126867 }, chance = 30, questId = 48705, coords = { {m=1171,x=33.9,y=47.3} }, },
	 ["Maddened Chaosrunner"] = 						 { cat = LEGION, type = MOUNT, method = NPC, name = L["Maddened Chaosrunner"], spellId = 253058, itemId = 152814, npcs = { 126852 }, chance = 30, questId = 48695, coords = { {m=1170,x=55.7,y=59.8} }, },
	 ["Vile Fiend"] = 									 { cat = LEGION, type = MOUNT, method = NPC, name = L["Vile Fiend"], spellId = 243652, itemId = 152790, npcs = { 127288 }, chance = 30, questId = 48821, coords = { {m=1171,x=63.1,y=25.3} }, },
	 ["Darkspore Mana Ray"] =							 { cat = LEGION, type = MOUNT, method = USE, name = L["Darkspore Mana Ray"], spellId = 235764, itemId = 152843, items = { 153191 }, chance = 16, },
	 ["Felglow Mana Ray"] =								 { cat = LEGION, type = MOUNT, method = USE, name = L["Felglow Mana Ray"], spellId = 253108, itemId = 152841, items = { 153191 }, chance = 16, },
	 ["Scintillating Mana Ray"] =						 { cat = LEGION, type = MOUNT, method = USE, name = L["Scintillating Mana Ray"], spellId = 253109, itemId = 152840, items = { 153191 }, chance = 16, },
	 ["Vibrant Mana Ray"] =								 { cat = LEGION, type = MOUNT, method = USE, name = L["Vibrant Mana Ray"], spellId = 253106, itemId = 152842, items = { 153191 }, chance = 16, },
    ...
    pets = {
     ...
     ["Scraps"] =                                        { cat = LEGION, type = PET, method = SPECIAL, name = L["Scraps"], spellId = 240064, itemId = 146953, chance = 33, creatureId = 120397, coords = {{m=1021}}, },
					...
					-- 7.3
					["Breezy Essence"] =                                { cat = LEGION, type = PET, method = BOSS, name = L["Breezy Essence"], itemId = 152974, spellId = 253818, creatureId = 127863, npcs = { 99999 }, tooltipNpcs = { 45870, 45871, 45872 }, chance = 10,  statisticId = { 5574, 5575 }, lockBossName = "Conclave of Wind", doNotUpdateToHighestStat = true, coords = {{m=773,x=47.5,y=26,i=true}},},
					["Cinderweb Egg"] =                                 { cat = LEGION, type = PET, method = BOSS, name = L["Cinderweb Egg"], itemId = 152976, spellId = 253918, creatureId = 127948, npcs = { 99999 }, tooltipNpcs = { 52498 }, chance = 10, statisticId = { 5964, 5965 }, lockBossName = "Beth'tilac", doNotUpdateToHighestStat = true, coords = {{m=800,x=21,y=32.7,f=0,i=true}},},
					["Elementium Back Plate"] =                         { cat = LEGION, type = PET, method = BOSS, name = L["Elementium Back Plate"], itemId = 152980, spellId = 253927, creatureId = 127953, npcs = { 99999 }, tooltipNpcs = { 53879 }, chance = 10, statisticId = { 6165, 6166 }, lockBossName = "Spine of Deathwing", doNotUpdateToHighestStat = true, coords = {{m=824,x=33.2,y=85.2,f=5,i=true}},},
					["Experiment-In-A-Jar"] =                           { cat = LEGION, type = PET, method = BOSS, name = L["Experiment-In-A-Jar"], itemId = 152967, spellId = 253790, creatureId = 127852, npcs = { 99999 }, tooltipNpcs = { 41378 }, chance = 10, statisticId = { 5559, 5560 }, lockBossName = "Maloriak", doNotUpdateToHighestStat = true, coords = {{m=754,x=71.4,y=70.2,f=2,i=true}},},
					["Fandral's Pet Carrier"] =                         { cat = LEGION, type = PET, method = BOSS, name = L["Fandral's Pet Carrier"], itemId = 152978, spellId = 253925, creatureId = 127951, npcs = { 99999 }, tooltipNpcs = { 52571 }, chance = 10, statisticId = { 5974, 5975 }, lockBossName = "Majordomo Staghelm", doNotUpdateToHighestStat = true, coords = {{m=800,x=50.9,y=72.4,f=2,i=true}},},
					["Lesser Circle of Binding"] =                      { cat = LEGION, type = PET, method = BOSS, name = L["Lesser Circle of Binding"], itemId = 152970, spellId = 253809, creatureId = 127858, npcs = { 99999 }, tooltipNpcs = { 43687, 43686, 43688, 43689, 43735 }, chance = 10, statisticId = { 5569, 5570 }, lockBossName = "Ascendant Council", doNotUpdateToHighestStat = true, coords = {{m=758,x=42.5,45.5,f=2,i=true}},},
    	["Model D1-BB-L3R"] =                               { cat = LEGION, type = PET, method = USE, name = L["Model D1-BB-L3R"], spellId = 233647, itemId = 151645, items = { 151638 }, chance = 100, creatureId = 117340, questId = 47895, coords = {{m=27,x=26.8,y=36.3,n=L["Environeer Bert"]}}, },
					["Odd Twilight Egg"] =                              { cat = LEGION, type = PET, method = BOSS, name = L["Odd Twilight Egg"], itemId = 152969, spellId = 253805, creatureId = 127857, npcs = { 99999 }, tooltipNpcs = { 45993, 45992 }, chance = 10, statisticId = { 5567, 5568 }, lockBossName = "Theralion and Valiona", doNotUpdateToHighestStat = true, coords = {{m=758,f=1,i=true}},},
					["Puddle of Black Liquid"] =                        { cat = LEGION, type = PET, method = BOSS, name = L["Puddle of Black Liquid"], itemId = 152979, spellId = 253926, creatureId = 127952, npcs = { 99999 }, tooltipNpcs = { 55312 }, chance = 10, statisticId = { 6157, 6158 }, lockBossName = "Yor'sahj the Unsleeping", doNotUpdateToHighestStat = true, coords = {{m=824,x=46.8,y=49.9,f=2,i=true}},},
					["Rough-Hewn Remote"] =                             { cat = LEGION, type = PET, method = BOSS, name = L["Rough-Hewn Remote"], itemId = 152966, spellId = 253788, creatureId = 127850, npcs = { 99999 }, tooltipNpcs = { 42179, 42166, 42180, 42178 }, chance = 10, statisticId = { 5557, 5558 }, lockBossName = "Omnotron Defense System", doNotUpdateToHighestStat = true, coords = {{m=754,x=61.4,y=57.4,f=1,i=true}},},
					["Severed Tentacle"] =                              { cat = LEGION, type = PET, method = BOSS, name = L["Severed Tentacle"], itemId = 152981, spellId = 253928, creatureId = 127954, npcs = { 99999 }, tooltipNpcs = { 56173 }, chance = 10,  statisticId = { 6167, 6168 }, lockBossName = "Madness of Deathwing", doNotUpdateToHighestStat = true, coords = {{m=824,f=6,i=true}},},
					["Smoldering Treat"] =                              { cat = LEGION, type = PET, method = BOSS, name = L["Smoldering Treat"], itemId = 152975, spellId = 253916, creatureId = 127947, npcs = { 99999 }, tooltipNpcs = { 53691 }, chance = 10, statisticId = { 5968, 5969 }, lockBossName = "Shannox", doNotUpdateToHighestStat = true, coords = {{m=800,x=49.3,y=44.3,f=0,i=true}},},
					["Shadowy Pile of Bones"] =                         { cat = LEGION, type = PET, method = BOSS, name = L["Shadowy Pile of Bones"], itemId = 152968, spellId = 253799, creatureId = 127853, npcs = { 99999 }, tooltipNpcs = { 41376, 41270 }, chance = 10, statisticId = { 5565, 5566 }, lockBossName = "Nefarian's End", doNotUpdateToHighestStat = true, coords = {{m=754,x=48,y=70.2,f=2,i=true}},},
		...
		["Thistleleaf Adventurer"] =                        { cat = LEGION, type = PET, method = USE, name = L["Thistleleaf Adventurer"], spellId = 195369, itemId = 130167, items = { 151464 }, chance = 100, creatureId = 99389, coords = {{m=1018,x=54.6,y=73.2,n=L["Sylvia Hartshorn"]}}, },
					["Twilight Summoning Portal"] =                     { cat = LEGION, type = PET, method = BOSS, name = L["Twilight Summoning Portal"], itemId = 152972, spellId = 253813, creatureId = 127859, npcs = { 99999 }, tooltipNpcs = { 43324 }, chance = 10, statisticId = { 5572, 5571 }, lockBossName = "Cho'gall", doNotUpdateToHighestStat = true, coords = {{m=758,x=73.4,75.4,f=2,i=true}},},
					["Vibrating Stone"] =                               { cat = LEGION, type = PET, method = BOSS, name = L["Vibrating Stone"], itemId = 152977, spellId = 253924, creatureId = 127950, npcs = { 99999 }, tooltipNpcs = { 53494 }, chance = 10, statisticId = { 5972, 5973 }, lockBossName = "Baleroc", doNotUpdateToHighestStat = true, coords = {{m=800,x=49.5,y=30.9,f=0,i=true}},},
					["Zephyr's Call"] =                                 { cat = LEGION, type = PET, method = BOSS, name = L["Zephyr's Call"], itemId = 152973, spellId = 253816, creatureId = 127862, npcs = { 99999 }, tooltipNpcs = { 46753 }, chance = 10,  statisticId = { 5576, 5577 }, lockBossName = "Al'Akir", doNotUpdateToHighestStat = true, coords = {{m=773,i=true}},},
					["Docile Skyfin"] =									{ cat = LEGION, type = PET, method = USE, name = L["Docile Skyfin"], spellId = 254295, itemId = 153054, items = { 153191 }, chance = 5, creatureId = 128157, },
					["Fel-Afflicted Skyfin"] =							{ cat = LEGION, type = PET, method = USE, name = L["Fel-Afflicted Skyfin"], spellId = 254296, itemId = 153055, items = { 153191 }, chance = 5, creatureId = 128158, },
					["Rebellious Imp"] =								{ cat = LEGION, type = PET, method = NPC, name = L["Rebellious Imp"], spellId = 254749, itemId = 153252, npcs = { 127705 }, chance = 16, creatureId = 128388, questId = 48970, sourceText = L["Use imp meat to summon boss."], coords = { {m=1171,x=67,y=17.5} }, },
					["Grasping Manifestation"] =						{ cat = LEGION, type = PET, method = NPC, name = L["Grasping Manifestation"], spellId = 254297, itemId = 153056, npcs = { 126887 }, chance = 6, creatureId = 128159, questId = 48709, coords = { {m=1170,x=30.4,y=40.5} }, },
					["Uuna's Doll"] =									{ cat = LEGION, type = PET, method = NPC, name = L["Uuna's Doll"], spellId = 254763, itemId = 153195, npcs = { 127581 }, chance = 20, creatureId = 128396, questId = 48966, sourceText = L["Have to find items to be able to summon."], coords = { {m=1171,x=54.2,y=38.2} }, },
				},
     ...
     ["Displacer Meditation Stone"] =                    { cat = LEGION, type = ITEM, isToy = true, method = SPECIAL, name = L["Displacer Meditation Stone"], itemId = 141298, chance = 33, questId = 43943, coords = {{m=1033}} },
					...
					["Blue Conservatory Scroll"] = 						{ cat = LEGION, type = ITEM, isToy = true, method = NPC, name = L["Blue Conservatory Scroll"], itemId = 153179, npcs = { 126900, }, chance = 9, questId = 48718, coords = { {m=1170,x=61.3,y=50.6} }, },
					["Red Conservatory Scroll"] = 						{ cat = LEGION, type = ITEM, isToy = true, method = NPC, name = L["Red Conservatory Scroll"], itemId = 153181, npcs = { 126900, }, chance = 9, questId = 48718, coords = { {m=1170,x=61.3,y=50.6} }, },
					["Yellow Conservatory Scroll"] = 					{ cat = LEGION, type = ITEM, isToy = true, method = NPC, name = L["Yellow Conservatory Scroll"], itemId = 153180, npcs = { 126900, }, chance = 9, questId = 48718, coords = { {m=1170,x=61.3,y=50.6} }, },
					["Legion Communication Orb"] = 						{ cat = LEGION, type = ITEM, isToy = true, method = NPC, name = L["Legion Communication Orb"], itemId = 153194, npcs = { 127703, }, chance = 10, questId = 48968, sourceText = L["Requires 3 people to stand on runes."], coords = { {m=1171,x=58,y=12} }, },
					["Spire of Spite"] = 								{ cat = LEGION, type = ITEM, isToy = true, method = NPC, name = L["Spire of Spite"], itemId = 153124, npcs = { 123464, }, chance = 12, questId = 48565, coords = { {m=1135,x=53.5,y=31.5} }, },
					["S.F.E. Interceptor"] = 							{ cat = LEGION, type = ITEM, isToy = true, method = NPC, name = L["S.F.E. Interceptor"], itemId = 153253, npcs = { 127700, }, chance = 7, questId = 48967, sourceText = L["Requires farming items from 'Terminus' to unlock portal."], coords = { {m=1171,x=77.5,y=74.5} }, },
					["Micro-Artillery Controller"] = 					{ cat = LEGION, type = ITEM, isToy = true, method = NPC, name = L["Micro-Artillery Controller"], itemId = 153126, npcs = { 126338, }, chance = 5, questId = 48814, coords = { {m=1171,x=61.3,y=65.3} }, },
					["Barrier Generator 1"] = 					{ cat = LEGION, type = ITEM, isToy = true, method = NPC, name = L["Barrier Generator"], itemId = 153183, npcs = { 126866, }, chance = 30, questId = 48724, coords = { {m=1170,x=63.8,y=64.6} }, },
					["Barrier Generator 2"] = 					{ cat = LEGION, type = ITEM, isToy = true, method = NPC, name = L["Barrier Generator"], itemId = 153183, npcs = { 126865, }, chance = 30, questId = 48723, coords = { {m=1170,x=36.6,y=23.8} }, },
