...
function R:PrepareDefaults()
   ...
   groups = {
    ...
    mounts = {
	 ...
	 ["Lambent Mana Ray"] = 							 { cat = LEGION, type = MOUNT, method = NPC, name = L["Lambent Mana Ray"], spellId = 253107, itemId = 152844, npcs = { 126867 }, chance = 30, questId = 48705, coords = { {m=1170,x=33.9,y=47.3} }, },
