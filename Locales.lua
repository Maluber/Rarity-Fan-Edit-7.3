...
L["Pond Nettle"] = true
L["'Hope's Landing' safest place to fish."] = true
...
L["Use imp meat to summon boss."] = true
L["Have to find items to be able to summon."] = true
L["Rebellious Imp"] = true
L["Grasping Manifestation"] = true
L["Uuna's Doll"] = true
L["Sightless Eye"] = true
L["Need to buy 'Observer's Locus Resonator' for '500 Intact Demon Eyes' to gain access."] = true
L["Baarut the Brisk"] = true
L["Blue Conservatory Scroll"] = true
L["Red Conservatory Scroll"] = true
L["Yellow Conservatory Scroll"] = true
L["Requires 3 people to stand on runes."] = true
L["Legion Communication Orb"] = true
L["Spire of Spite"] = true
L["Requires farming items from 'Terminus' to unlock portal."] = true
